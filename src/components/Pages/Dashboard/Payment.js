...
const Payment = () => {
  const { id } = useParams();
  const url = `https://polar-sierra-20396.herokuapp.com/order/${id}`;
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-12 mt-32 ">
      <div class="card w-50 h-full  bg-base-100 shadow-xl  ">
        <div class="card-body ">
          <p className="text-success font-bold mx-auto">
          ...
          <p className="font-bold text-center">Total Amount: ${order.price}</p>
        </div>
      </div>
      <div class="card flex-shrink-0 w-50  shadow-2xl bg-base-100 p-6 ">
        <div class="card-body">
